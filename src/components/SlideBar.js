  ...
  return (
    <div className="flex-none  bg-black h-screen min-w-[25%] fixed ">
      <div className="nav flex  text-white text-lg mt-10 flex-col align-middle justify-center text-center w-full gap-5 overflow-hidden">
        <div data-aos="slide-down">
          <img
            ...
            alt="Said Boussif"            className="rounded-full border-solid cursor-pointer  border-[8px] border-stone-600 min-h-fit mx-auto  max-w-[190px]"
          />
      ...
      >
        <div
          onClick={() =>
            window.open("https://github.com/ISNTIC-2021", "_blank")
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.instagram.com/saidboussif1", "_blank")
          }
        >
          {" "}
        ...
        <div
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/said-boussif",
              "_blank"
            )
          }
        >
        ...
        <div
          onClick={() =>
            window.open("https://www.facebook.com/profile.php?id=100010889835226", "_blank")
          }
        >
