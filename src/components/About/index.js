      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Said Boussif,</span> a Web
            developer
          </h3>
          <p
            ...
            data-aos={"fade-left"}
          >
            &nbsp;&nbsp;&nbsp;I recently graduated from <b>Institut Spécialisé de Technologie Appliquée NTIC </b>  in Morocco with a specialization in web development, specifically in web full-stack development. I am {new Date().getFullYear() - 2003} years old and have a passion for exploring new technologies.
          </p>
          ...
          <p
            ...
            data-aos={"fade-right"}
          >
            &nbsp;&nbsp;&nbsp;I am currently actively seeking job opportunities. I have experience working with technologies such as ReactJS, Laravel, MySQL, MongoDB, Bootstrap, and many more. I am also eager to collaborate on open-source projects.
          </p>
        </div>
